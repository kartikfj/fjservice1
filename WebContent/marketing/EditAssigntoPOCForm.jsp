...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> BDM Support Request  <small>Marketing Portal</small> </h1>
      <ol class="breadcrumb">
				  ...
				  <table class="table table-hover" id="sep2viewtable">
				    ...
				    <c:forEach var="requestList"  items="${SRLIST}" >
				     <c:set var="reqstCode" value="${requestList.id}" scope="page" />
				      <c:set var="seempCode" value="${requestList.bdmEmpCode}" scope="page" />
<%-- 				        <c:set var="reqstTyp" value="${requestList.type}" scope="page" /> --%>
				    <tr>
				        <td>
				        <dl class="dl-horizontal">
				        <dt>Code : </dt>
		                <dd>FJMPOC ${requestList.id}</dd>
		                 <dt>SE. Name : </dt>
...
<%-- 		                  <fmt:formatDate value="${theDate}" /></dd> --%>
		     ...
		     <form action="AssignToPOC" method="POST" id="processTwo" name="se_followup_form">
       ...
       <c:when test="${P1 eq 1 and P2 eq 1 and P3 eq 0 and P4 eq 0  and fjtuser.role ne 'mkt'}">     
          <div class="row mkt-form-row-border">
                <div class="col-xs-12  table-responsive no-padding">
				  <table class="table table-hover" id="sep2viewtable">
				    <tbody>
...
<%-- 				        <c:set var="reqstTyp" value="${requestList.type}" scope="page" /> --%>
				    <tr>
		                ...
		                <dd>FJMPOC ${requestList.id}</dd>
		                 ...
		                 <dd>${requestList.seName}</dd>
		                 <dt>Task : </dt>
		                <dd>${requestList.bdmTaskName}</dd>
		                <dt>Initail Remarks : </dt>
		                <dd>${requestList.initialReamrks}</dd>               
				       </dl>
				       </td>
				        <td>
				        <dl class="dl-horizontal">
		                  <dt>Ack. Status by POC. : </dt>
		                <dd>
		                  <c:choose>
		                ...
		                <dt>Ack.Remks by POC. : </dt>
		                <dd>${requestList.se_accept_remarks}</dd>
		                <dt>Ack.Followup by POC. : </dt>
		     ...
		     <form action="AssignToPOC" method="POST" id="processThree" name="se_followup_form">
		     <div class="col-md-8">
             <div class="col-md-7 pull-right">
	            <div class="form-group">
	                <label>POC. Follow-Up Status</label> 
         ...
         <%-- Process-4  --%>
        <c:when test="${P1 eq 1 and P2 eq 1 and P3 eq 1 and P4 eq 0  and fjtuser.role eq 'mkt' and  fjtuser.sales_code ne null }"> 
        <div class="row mkt-form-row-border">
            <div class="col-xs-12  table-responsive no-padding"">
				  <table class="table table-hover" id="sep2viewtable">
				    <tbody>
...
<%-- 		                  <fmt:formatDate value="${theDate}" /></dd>          --%>
		                ...
		                <dt>Ack.Remarks by POC. : </dt>
		                <dd>${requestList.se_accept_remarks}</dd>
		                <dt>POC Follow-Up Status : </dt>
		                <dd>
		                  <c:choose>
...
<%-- 		         <fmt:formatDate value="${theDate3}" /></dd> --%>
			...
			<form action="AssignToPOC" method="POST" id="processFour" name="se_followup_form">	
            <div class="col-md-5">
            
	            <div class="form-group">
	                <label>Remarks By BDM:</label> 
