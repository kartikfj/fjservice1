...
public class LogisticReportController extends HttpServlet {
	...
	private void checkUserLogisticPortalPermission(HttpServletRequest request, HttpServletResponse response, String empCode, String division, String userRole) throws IOException, ServletException {
		try { 
	...
	private void getPODetails(HttpServletRequest request, HttpServletResponse response, String txnCode, String divnCode, String empCode) throws SQLException, ServletException, IOException {  
